...
static Settings _settings = { true, true, false, true, true, 0, 1 };
...
inline void settingsLoad() {
  ...
  _settings.hostOs   = _prefs.getUChar("s_host", 1);
  if (_settings.hostOs > 1) _settings.hostOs = 1;
  _prefs.end();
}
...
inline void settingsSave() {
  ...
  _prefs.putUChar("s_host", _settings.hostOs);
  _prefs.end();
}
